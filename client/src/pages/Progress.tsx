  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-quicksand font-bold mb-2">
            Your Progress
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-quicksand font-semibold mb-2">
                {progressPercentage}%
              </div>
              <Progress value={progressPercentage} className="h-2" />
              <p className="text-xs text-muted-foreground mt-2">
                Based on assessment and completed exercises
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Progress
                value={(user.streak / 10) * 100}
                className="h-2 bg-muted"
              />
              <p className="text-xs text-muted-foreground mt-2">
                Keep it going to earn more achievements!
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Progress
                value={
                  ((user.xpPoints % (user.level * 100)) / (user.level * 100)) *
                  100
                }
                className="h-2"
              />
              <p className="text-xs text-muted-foreground mt-2">
                Level {user.level} •{" "}
                {user.level * 100 - (user.xpPoints % (user.level * 100))} XP to
                next level
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Progress
                value={
                  exercises ? Math.min((exercises.length / 20) * 100, 100) : 0
                }
                className="h-2"
              />
              <p className="text-xs text-muted-foreground mt-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    How your mood has changed over the last 7 days
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-80">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Your exercise activity over the last 7 days
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-80">
                    {exerciseTrendData.length > 0 &&
                    exerciseTrendData.some((d) => d.count > 0) ? (
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart
              ...
              <Card>
                ...
                <CardContent>
                  <div className="h-80">
                    ...
                    moodDistribution.some((d) => d.value > 0) ? (
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                ...
                <CardContent>
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-quicksand font-semibold mb-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Breakdown of exercises you've completed
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-80">
                    {exerciseTypeDistribution.length > 0 &&
                    exerciseTypeDistribution.some((d) => d.value > 0) ? (
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                      ...
                      <div className="flex items-center justify-center h-full">
                        <div className="text-center">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            Complete different types of exercises to see
                            distribution
                          </p>
                        </div>
                      </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Understanding your exercise patterns
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {exerciseTrendData.filter((d) => d.count > 0).length >
                          0
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {/* Mood Master Badge */}
                  <div
                    className={`border rounded-lg p-4 ${achievements?.some((a) => a.badgeId === "mood-master") ? "bg-primary/10" : "bg-muted/50"}`}
                  >
                    <div className="flex items-center mb-4">
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center mr-3 ${achievements?.some((a) => a.badgeId === "mood-master") ? "bg-accent" : "bg-muted"}`}
                      >
                        <Smile
                          className={`h-6 w-6 ${achievements?.some((a) => a.badgeId === "mood-master") ? "text-primary" : "text-muted-foreground/40"}`}
                        />
                      </div>
                      <div>
                  ...
                  {/* 7-Day Streak Badge */}
                  <div
                    className={`border rounded-lg p-4 ${user.streak >= 7 ? "bg-primary/10" : "bg-muted/50"}`}
                  >
                    <div className="flex items-center mb-4">
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center mr-3 ${user.streak >= 7 ? "bg-accent" : "bg-muted"}`}
                      >
                        <Zap
                          className={`h-6 w-6 ${user.streak >= 7 ? "text-primary" : "text-muted-foreground/40"}`}
                        />
                      </div>
                      <div>
                        <h3 className="font-quicksand font-semibold">
                  ...
                  <div
                    className={`border rounded-lg p-4 ${achievements?.some((a) => a.badgeId === "journal-master") ? "bg-primary/10" : "bg-muted/50"}`}
                  >
                    <div className="flex items-center mb-4">
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center mr-3 ${achievements?.some((a) => a.badgeId === "journal-master") ? "bg-accent" : "bg-muted"}`}
                      >
                        <BookOpen
                          className={`h-6 w-6 ${achievements?.some((a) => a.badgeId === "journal-master") ? "text-primary" : "text-muted-foreground/40"}`}
                        />
                      </div>
                      <div>
                        <h3 className="font-quicksand font-semibold">
                  ...
                  {/* Mindfulness Badge */}
                  <div
                    className={`border rounded-lg p-4 ${achievements?.some((a) => a.badgeId === "mindfulness") ? "bg-primary/10" : "bg-muted/50"}`}
                  >
                    <div className="flex items-center mb-4">
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center mr-3 ${achievements?.some((a) => a.badgeId === "mindfulness") ? "bg-accent" : "bg-muted"}`}
                      >
                        <Brain
                          className={`h-6 w-6 ${achievements?.some((a) => a.badgeId === "mindfulness") ? "text-primary" : "text-muted-foreground/40"}`}
                        />
                      </div>
                      <div>
                        <h3 className="font-quicksand font-semibold">
                  ...
                  {/* Breath Master Badge */}
                  <div
                    className={`border rounded-lg p-4 ${achievements?.some((a) => a.badgeId === "breath-master") ? "bg-primary/10" : "bg-muted/50"}`}
                  >
                    <div className="flex items-center mb-4">
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center mr-3 ${achievements?.some((a) => a.badgeId === "breath-master") ? "bg-accent" : "bg-muted"}`}
                      >
                        <Wind
                          className={`h-6 w-6 ${achievements?.some((a) => a.badgeId === "breath-master") ? "text-primary" : "text-muted-foreground/40"}`}
                        />
                      </div>
                      <div>
                        <h3 className="font-quicksand font-semibold">
                  ...
                  {/* CBT Champion Badge */}
                  <div
                    className={`border rounded-lg p-4 ${achievements?.some((a) => a.badgeId === "cbt-champion") ? "bg-primary/10" : "bg-muted/50"}`}
                  >
                    <div className="flex items-center mb-4">
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center mr-3 ${achievements?.some((a) => a.badgeId === "cbt-champion") ? "bg-accent" : "bg-muted"}`}
                      >
                        <PenLine
                          className={`h-6 w-6 ${achievements?.some((a) => a.badgeId === "cbt-champion") ? "text-primary" : "text-muted-foreground/40"}`}
                        />
                      </div>
                      <div>
                        <h3 className="font-quicksand font-semibold">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Complete 5 cognitive exercises
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
